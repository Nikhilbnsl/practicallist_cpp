...
using namespace std;
/*
QUES 13 Create a class student containing fields for roll number, name, class,  year and total marks.
 Write a program to store five objects of student class in a file. Retrieve these records from file and display them. */
